...
void myData()
{
	...
	{
		// positions         //
			-0.93f,0.0f,0.0f, //LETRA B (|) top left 
			-0.85f,0.0f,0.0f,// top right
			-0.93f,-0.7f,0.0f, //bottom left 
			-0.85f,-0.7f,0.0f,//bottom right 

			-0.85f,0.0f,0.0f, //LETRA B (-) top left 
			-0.85f,-0.1f,0.0f,//bottom left 
			-0.75f,0.0f,0.0f,//top right
			-0.8f,-0.1f,0.0f,//bottom right

			-0.85f,-0.6f,0.0f, //LETRA B (-) top left abajo
			-0.85f,-0.7f,0.0f,//bottom left 
			-0.75f,-0.6f,0.0f,//top right
			-0.7f,-0.7f,0.0f,//bottom r
		
			-0.85f,-0.3f,0.0f, //LETRA B (-) top left en medio
			-0.85f,-0.4f,0.0f,//bottom left 
			-0.8f,-0.3f,0.0f,//top right
			-0.75,-0.4f,0.0f,//bottom r
			...
			- 0.7f,-0.55f,0.0f,
			-0.65f,-0.55f,0.0f,
			-0.75f,-0.3f,0.0f,//bottom r
			-0.8f,-0.3f,0.0f,

			//LETRA O
			-0.5f,0.0f,0.0f, //top left
			-0.43f,0.0f,0.0f,//top right
			-0.5f,-0.7f,0.0f,//bottom left
			-0.43f,-0.7f,0.0f,//bottom right
			...
			-0.43f,0.0f,0.0f,//top left 
			-0.23f,0.0f,0.0f,//top right
			-0.43f,-0.1f,0.0f,
			-0.23f,-0.1f,0.0f,
			...
			-0.16f,0.0f,0.0f, 	//LETRA M //top left
			-0.1f,0.0f,0.0f,//top right
			-0.16f,-0.7f,0.0f,//bottom left
			-0.1f,-0.7f,0.0f, //bottom right

			0.1f,0.0f,0.0f, 	//LETRA M //top left
			0.15f,0.0f,0.0f,//top right
			0.1f,-0.7f,0.0f,//bottom left
			0.15f,-0.7f,0.0f, //bottom right
	...
	{
			0,2,3,1,4,6,7,5,8,10,11,9,12,14,15,13,16,18,19,17,20,21,22,23,24,25,27,26,28,29,30,31,32,33,35,34,
			36,37,39,38,40,41,43,42,44,45,47,46,48,49,51,50,52,53,55,54,56,57,58,59,60,61,62,63
	};
