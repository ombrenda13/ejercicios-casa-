...
//GRUPO 4 laboratorio COMPUTACIÓN GRÁFICA
//INSTRUCCIONES
...
//	TECLA W: acercar
//	TECLA S: alejar
// barra espaciadora_ avanzar
// TECLA P:avanza coche 
//tecla R: coche reversa
...
void animate(void)
{
	if (play) {
		...
		if (estado == 1) { //ESTADO b
			...
			if (movKit_z < 180) {//SIGO EN EL ESTADO B    
				movKit_z += 1.0f;
				//printf("%f \n", movKit_x);
			}
			else {
